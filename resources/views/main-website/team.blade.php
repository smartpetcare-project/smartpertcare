...
@section('content')
    ...
    <section class="testimonial-style1-area">
        <div class="image-box1"><img src="{{ URL::asset('main-website/images/testimonial/testimonial-image-1.png') }}"
                alt=""></div>
        <div class="image-box2"><img src="{{ URL::asset('main-website/images/testimonial/testimonial-image-2.png') }}"
                alt=""></div>
        <div class="image-box3 paroller"><img
                src="{{ URL::asset('main-website/images/testimonial/testimonial-image-3.png') }}" alt=""></div>
        <div class="image-box4 paroller"><img
                src="{{ URL::asset('main-website/images/testimonial/testimonial-image-4.png') }}" alt=""></div>
