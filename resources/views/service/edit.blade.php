...
@section('content')
    <x-page-title title="Layanan" subtitle="Edit Layanan" />
    <form id="serviceForm" enctype="multipart/form-data" method="POST" action="{{ route('service.update', $service->uuid) }}">
        <div class="row">
            @csrf
            @method('PUT')
            <div class="col-12 col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <div class="mb-4">
                            <h5 class="mb-3">Judul Layanan</h5>
                            ...
                            <div class="mb-4">
                                ...
                                <div id="{{ $name }}_preview" class="file-preview">
                                    @if (isset($service->{$name}))
                                        <img src="{{ $service->{$name} }}" alt="{{ $label }}"
                        ...
                        <div class="mb-4">
                            ...
                            <div id="filePreview" class="file-preview">
                                @foreach ($service->image_content as $image)
        ...
        tinymce.init({
            ...
            setup: function(editor) {
                editor.on('init', function() {
                    ...
                    var content = @json($service->content);
