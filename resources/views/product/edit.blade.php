...
@section('content')
    <x-page-title title="Produk" subtitle="Edit Produk" />
    <form id="productForm" enctype="multipart/form-data" method="POST" action="{{ route('product.update', $product['uuid']) }}">
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="form-control" placeholder="100.000" id="formatted_price" required
                                oninput="formatPrice(this)" value="{{ $product['price'] }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div id="{{ $name }}_preview" class="file-preview">
                                    @if (isset($product->{$name}))
                                        <img src="{{ $product->{$name} }}" alt="{{ $label }}"
                        ...
                        <div class="mb-4">
                            ...
                            <div id="filePreview" class="file-preview">
                                @foreach ($product->image_content as $image)
        ...
        tinymce.init({
            ...
            setup: function(editor) {
                editor.on('init', function() {
                    var content = @json($product->description);
